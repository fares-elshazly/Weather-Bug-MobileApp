...
class ColorSpinner extends StatefulWidget {
  final double radius;
  final double dotRadius;

  ColorSpinner({this.radius = 30.0, this.dotRadius = 3.0});

  @override
  _ColorSpinnerState createState() => _ColorSpinnerState();
}

class _ColorSpinnerState extends State<ColorSpinner>
